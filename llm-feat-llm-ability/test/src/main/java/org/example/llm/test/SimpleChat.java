...
public class SimpleChat {
    ...
    static final String SCHOOL_ID = "1500000200043255097"; // 1500000200069226983

    static final String URL = "ws://"+ENV+"/beta/api/assistant/chat/completion?X-TOKEN="+TOKEN+"&X-APPKEY="+APP_KEY+"&X-DEVICEID="+DEVICE_ID+"&X-CLIENTTYPE="+CLIENT_TYPE+"&chatId=test-asst-chatId-1748440994";
