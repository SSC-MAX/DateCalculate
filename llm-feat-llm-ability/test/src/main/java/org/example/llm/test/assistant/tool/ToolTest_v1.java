...
//      static final String[] MODELS = {"kimi-k2-0711-preview"};
    ...
    public static void main(String[] args) throws ReflectiveOperationException, IOException {
        for (ScriptInfo scriptInfo : scriptInfoList) {
            for (String model : MODELS) {
                runSingle(scriptInfo.filePath, scriptInfo.fileName, model);
            }
        }
    }
    ...
    static void runSingle(String filePath, String fileName, String modelName) throws ReflectiveOperationException, IOException {
        ...
        for (ToolGetTimeScript script : toolGetTimeScripts) {
        ...
        buildResultExcel(data, filePath, fileName, modelName);

    }


    private static void buildResultExcel(List<List<String>> data, String filePath, String fileName, String modelName) throws IOException {
